...
class ClsDateUtil {
  ...
  static int calculateDayDifference(DateTime startDate, DateTime endDate) {
    return endDate.difference(startDate).inDays;
  }
  static Duration calculateDurationDifference(DateTime startDate, DateTime endDate) {
  ...
  static String getFormatDate(String formate, DateTime time) {
  ...
  static DateTime getDateTime(String strformat,String strDate){
    try{
      var format1 = DateFormat(strformat);
      return format1.parse(strDate);
    }catch(e){
      print("getDateTime=${strformat}=${strDate}="+e.toString());
      return DateTime.now();
    }
